...
const TermsAndConditions = () => {
  return (
    <div style={{ padding: "5%", paddingTop: "105px" }}>
      <h1 className="secondary-font">
        <strong>Terms and Conditions</strong>
      </h1>

      <p>Welcome to HighlyHandy!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Highly Handy's Website, located at{" "}
        <a href="https://highlyhandy.com">https://highlyhandy.com</a>.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use HighlyHandy if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing HighlyHandy, you agreed to
        use cookies in agreement with the Highly Handy's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Highly Handy and/or its licensors own the
        intellectual property rights for all material on HighlyHandy. All
        intellectual property rights are reserved. You may access this from
        HighlyHandy for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from HighlyHandy</li>
        <li>Sell, rent or sub-license material from HighlyHandy</li>
        <li>Reproduce, duplicate or copy material from HighlyHandy</li>
        <li>Redistribute content from HighlyHandy</li>
      </ul>
      ...
      <p>
        ...
        Highly Handy does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Highly Handy,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Highly Handy shall not be
      ...
      <p>
        Highly Handy reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Highly Handy a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Highly Handy; and (d) the link
      ...
      <p>
        ...
        e-mail to Highly Handy. Please include your name, your organization
      ...
      <p>
        No use of Highly Handy's logo or other artwork will be allowed for
