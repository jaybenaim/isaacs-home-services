...
const NavBar = (props) => {
  ...
  return (
    <Navbar bg="light" expand="lg" id="main-nav" fixed="top">
      ...
      <a href="tel:6472295873" className="mobile-icons">
        ...
        <span className="mobile-icons__text">647-229-5873</span>
      </a>

      <a href="mailto:isaac_palomi@outlook.com" className="mobile-icons">
        <i className="fa fa-envelope" id="nav-mail"></i>
        <span className="mobile-icons__text">isaac_palomi@outlook.com</span>
      </a>

      <div className="navbar-dropdown--right">
        <Button
          className={showDropdown ? "collapsed bars" : "bars"}
